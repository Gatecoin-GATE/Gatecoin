...
const QString BITCOIN_IPC_PREFIX("gatecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click gatecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start gatecoin: click-to-pay handler");
    else
...
{
    // clicking on gatecoin: URLs creates FileOpen events on the Mac:
