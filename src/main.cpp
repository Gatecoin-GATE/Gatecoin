...
// Copyright (c) 2013-2014 The Gatecoin developers
...
uint256 hashGenesisBlock("0x0000000fbc8cd34ef62f176fea7e60c05bbc8a2f8881f2f6c4c18c7a8f75cdbd");
...
const string strMessageMagic = "Gatecoin Signed Message:\n";
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 GATE if made of 50 GATE inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
static const int64 nGenesisBlockRewardCoin = 100000 * COIN; //100k premine(1% of 10 Millon (Max Supply))
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000004fbc3bcd805d15732d99b8726275436c61c1f6bcd4db8a58c1e0b98f1b");
    }
...
*/
        ...
        block.nNonce   = 134479108;

        if (fTestNet)
        {
            block.nTime    = 1596911936;
            block.nNonce   = 147425006;
        }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GatecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GatecoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("GatecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("gatecoin-miner");
    ...
    try { loop {
        ...
        printf("Running GatecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("GatecoinMiner terminated\n");
        throw;
    }
}
